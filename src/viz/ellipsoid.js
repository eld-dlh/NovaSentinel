...
export function buildEllipsoidTooltip(cdmRecord) {
  ...
  return {
    ...
    sat1Name:     cdmRecord.SAT1_OBJECT_NAME ?? cdmRecord.SAT_1_NAME ?? cdmRecord.SAT1_OBJECT_DESIGNATOR ?? '—',
    sat2Name:     cdmRecord.SAT2_OBJECT_NAME ?? cdmRecord.SAT_2_NAME ?? cdmRecord.SAT2_OBJECT_DESIGNATOR ?? '—',
